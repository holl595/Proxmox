...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/holl595/Proxmox/debian/ct/create_lxc.sh)" || exit
...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/holl595/Proxmox/debian/install/$var_install.sh)" || exit
